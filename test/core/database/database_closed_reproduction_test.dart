...
void main() {
  ...
  group('Database Closed Reproduction & Fix Tests', () {
    test(
      'ReadingDao with direct Database reference throws database_closed when db is closed',
      () async {
    ...
    test(
      'ReadingDao using AppDatabase getter automatically recovers and re-opens connection without throwing database_closed',
      () async {
